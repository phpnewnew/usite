...
<div style="height:30px">
	<div style="float:left;"><a class="btn1" href="/d/shenheok">商品列表</a></div>
	<div style="float:left;margin-left:10px"><a href="/d/shenhe">待审核列表</a></div>
	<div style="clear:both"></div>
</div>

<form action="/d/shenheok" method="GET">
<div >
...
<form action="/d/shenheok" method="POST">
...
<div class="pagerlist" style="margin-top:10px">
	<div class="page-bottom tp">
		<?php 
			...
			$viewpage = $page->ViewPage($totalcount,$totalpage,$pagenum,$pagesize,$param,"/d/shenheok");
			echo $viewpage;
		?>
	</div>
</div>
